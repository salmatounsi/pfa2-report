...
implémenter une solution applicative dédiée à la gestion d'une pépinière 
...
et la \autoref{fig:cycleV1} présente les étapes du cycle en V.
...
\caption{Les étapes de la méthodologie CRISP-DM \cite{crispdmRef}.}
\label{fig:crispDM}
\end{figure}
