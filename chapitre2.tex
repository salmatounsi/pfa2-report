...
\begin{itemize}
    ...
    \item effectuer un diagnostic de l'état de santé d'une plante à partir d'une image fournie, invoque un acteur secondaire :
    \item \subsection*{Module d'assistance au diagnostic et recommandation}
\begin{itemize}
...
\begin{itemize}
    \item La plateforme doit être capable de gérer simultanément un nombre important d'utilisateurs.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/CasUtilisation3.png}
...
\subsection{Cas d'utilisation << Gérer les plantes >>}
...
La \autoref{figure 2} présente le raffinement de cas d'utilisation << Gérer les plantes >>.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/gerer plante3.png}
    \caption{Raffinement du cas d'utilisation « Gérer les plantes »}
    \label{figure 2}
\end{figure}
...
\subsubsection{Cas d'utilisation << Modifier une plante >>}

Le \autoref{tableau 2} présente la description textuelle du cas d'utilisation « Modifier uneplante ».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Modifier une plante \\
\hline
\textbf{Acteur} & Vendeur, Administrateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Modifier une plante »}
\label{tableau 2}
\end{table}

\subsubsection{Cas d'utilisation << Ajouter une plante >>}

Le \autoref{tableau 3} présente la description textuelle du cas d'utilisation « Ajouter une plante ».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Ajouter une plante \\
\hline
\textbf{Acteur} & Vendeur, Administrateur \\
\hline
...
\textbf{Scénario nominal} &
\begin{enumerate}
    \item L'acteur accède à l'interface de gestion des plantes et clique sur « Ajouter une plante ».
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Ajouter une plante »}
\label{tableau 3}
\end{table}

\subsubsection{Cas d'utilisation << Supprimer une plante >>}

Le \autoref{tableau 4} présente la description textuelle du cas d'utilisation « Supprimer une plante ».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Supprimer une plante \\
\hline
\textbf{Acteur} & Vendeur, Administrateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Supprimer une plante »}
\label{tableau 4}
\end{table}

\subsection{Cas d'utilisation << Consulter les plantes >>}

Ce cas d'utilisation permet au vendeur de consulter la liste des plantes.
La \autoref{figure 3} repésente le raffinement du cas d'utilisation << Consulter les plantes >>.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/consulterPlanteVendeur2.png}
    \caption{Raffinement du cas d'utilisation « Consulter les plantes »}
    \label{figure 3}
\end{figure}

le \autoref{tableau 5} représente la description textuelle de cas d'utilisation « Consulter les plantes ».
\begin{table}[H]
\centering
\renewcommand{\arraystretch}{1.4}
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Consulter les plantes \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Consulter les plantes »}
\label{tableau 5}
\end{table}

\subsection{Cas d'utilisation << Consulter les commandes >>}

La \autoref{figure 4} présente le raffinement du cas d'utilisation « Consulter les commandes ».

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/consulter commandes3.png}
    \caption{Raffinement du cas d'utilisation « Consulter les commandes »}
    \label{figure 4}
\end{figure}
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Consulter les commandes \\
\hline
\textbf{Acteur} & Vendeur, Administrateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Consulter les commandes »}
\label{tableau 6}
\end{table}

\subsubsection{Cas d'utilisation << Accepter une commande >>}

Le \autoref{tableau 7} présente la description textuelle du cas d'utilisation « Accepter une commande ».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Accepter une commande \\
\hline
\textbf{Acteur} & Vendeur, Administrateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Accepter une commande »}
\label{tableau 7}
\end{table}

\subsubsection{Cas d'utilisation << Refuser une commande >>}

Le \autoref{tableau 8} présente la description textuelle du cas d'utilisation « Refuser une commande ».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Refuser une commande \\
\hline
\textbf{Acteur} & Vendeur, Administrateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Refuser une commande »}
\label{tableau 8}
\end{table}

\subsection{Cas d'utilisation << Gérer les comptes utilisateurs >>}

Ce cas d'utilisation permet à l'administrateur de gérer les comptes utilisateurs. 
La \autoref{figure 5} représente le raffinement du cas d'utilisation << Gérer les comptes utilisateurs >>

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/GererLesComptesUsers.drawio.png}
    \caption{Raffinement du cas d'utilisation « Gérer les comptes utilisateurs »}
    \label{figure 5}
\end{figure}

\subsubsection{Cas d'utilisation << Activer un compte utilisateur >>}

Le \autoref{tableau 9} présente la description textuelle du cas d'utilisation « Activer un compte utilisateur ».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Activer un compte utilisateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Activer un compte utilisateur »}
\label{tableau 9}
\end{table}

\subsubsection{Cas d'utilisation << Désactiver un compte utilisateur >>}

Le \autoref{tableau 10} présente la description textuelle du cas d'utilisation « Désactiver un compte utilisateur ».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Désactiver un compte utilisateur \\
\hline
\textbf{Acteur} & Administrateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Désactiver un compte utilisateur »}
\label{tableau 10}
\end{table}

\subsection{Cas d'utilisation << Consulter les comptes utilisateurs >>}

La \autoref{figure 6} présente le raffinement du cas d'utilisation « Consulter les comptes utilisateurs ».

\begin{figure}[H]
    \centering  
    \includegraphics[width=0.75\textwidth]{images/ConsulterLesComptesUsers.drawio.png}
    \caption{Raffinement du cas d'utilisation « Consulter les comptes utilisateurs »}
    \label{figure 6}
\end{figure}

Le tableau \autoref{tableau 11} représente la description textuelle du cas d'utilisation « Consulter les comptes utilisateurs »
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Consulter les comptes utilisateurs \\
\hline
\textbf{Acteur} & Administrateur \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Consulter les comptes utilisateurs »}
\label{tableau 11}
\end{table}
...
\subsection{Cas d'utilisation << Consulter les plantes disponibles à la vente >>}

Ce cas d'utilisation permet au vendeur de consulter la liste des plantes. 
La \autoref{figure 8} présente le raffinement du cas d'utilisation << Consulter les plantes disponibles à la vente >>. 

\begin{figure}[H]
    \centering  
    \includegraphics[width=0.75\textwidth]{images/ConsulterPlantesClient2.drawio.png}
    \caption{Raffinement du cas d'utilisation « Consulter les plantes disponibles à la vente»}
    \label{figure 8}
\end{figure}
Le \autoref{tableau 13} représente la description textuelle du cas d'utilisation « Consulter les plantes disponibles à la vente».
...
\begin{tabular}{|p{4cm}|p{10cm}|}
\hline
\textbf{Titre} & Consulter les plantes disponibles à la vente \\
\hline
\textbf{Acteur} & Client \\
\hline
...
\hline
\end{tabular}
\caption{Cas d'utilisation « Consulter les plantes disponibles à la vente »}
\label{tableau 13}
\end{table}
