...
\end{itemize} \\
\hline
Module d’assistance au diagnostic & Secondaire &
\begin{itemize}
...
\subsection*{Module d’assistance au diagnostic}
\begin{itemize}
    \item Le système doit intégrer un module d’intelligence artificielle chargé de l’analyse des images des plantes.
    \item Le module IA doit traiter les images envoyées par les clients et retourner un résultat de diagnostic.
\end{itemize}
...
\begin{itemize}
    ...
    \item Le système de diagnostic intelligent doit fournir des résultats dans des délais acceptables afin de garantir une expérience utilisateur fluide.
\end{itemize}
...
\begin{itemize}
    \item La plateforme doit être disponible de manière continue, avec un minimum d’interruptions.
\end{itemize}

\subsection*{Évolutivité}
\begin{itemize}
    \item L’architecture de la plateforme doit permettre l’intégration future de nouvelles fonctionnalités, notamment l’amélioration du système intelligent de diagnostic et de recommandation.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{images/diag cas d'utilisation global.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/gérer plante.png}
    \caption{Raffinement du cas d’utilisation « Gérer plante »}
\end{figure}

\subsubsection{Cas d’utilisation << Modifier le stock >>}

Le tableau présente la description textuelle du cas d’utilisation « Modifier le stock ».
...
\hline
\textbf{Titre} & Modifier le stock \\
\hline
\textbf{Acteur} & Vendeur, Administrateur \\
\hline
\textbf{Résumé} & Cas d’utilisation permettant à un vendeur ou à un administrateur de modifier le stock. \\
\hline
\textbf{Préconditions} &
\begin{itemize}
...
\begin{enumerate}
    ...
    \item L’acteur sélectionne le produit à modifier.
...
\hline
\end{tabular}
\caption{Cas d’utilisation « Modifier le stock »}
\end{table}
...
\textbf{Postconditions} &
\begin{itemize}
    \item La description de la plante est mise à jour.
\end{itemize} \\
\hline
\textbf{Scénario nominal} &
\begin{enumerate}
