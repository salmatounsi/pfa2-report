...
Dans cette partie, nous décrivons les différentes interfaces de notre plate-forme, PhytoCare
    ...
    La \autoref{fig:con} est la page de connexion.
        \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\textheight]{images/login.png}
        ...
        La \autoref{fig:acc1} et la \autoref{fig:acc2} sont la page d'accueil.
       
        \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\textheight]{images/pagedacc(2).png}
        ...
        \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\textheight]{images/pagedacc.png}
