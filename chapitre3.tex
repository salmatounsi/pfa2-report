...
La \autoref{figure: Décomposition modulaire du système} représente la décomposition modulaire du système.


\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.8\textwidth]{./images/modules.drawio.png}  
...
La \autoref{fig:modgestusers} représente la composition du module de gestion des utilisateurs.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.7\textwidth]{./image/gestionUtilisateur.png}  
    \label{fig:modgestusers}   % label pour faire référence dans le texte
...
La \autoref{fig:modgestplantes} représente la composition du module de gestion des plantes.


\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/gestionPlante.png}  
    \label{fig:modgestplantes}   % label pour faire référence dans le texte
...
\end{itemize}
La \autoref{fig:modgestcmd} représente la composition du module de gestion des commandes.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/gestionCommande.png}  
    \label{fig:modgestcmd}   % label pour faire référence dans le texte
...
\end{itemize}
La \autoref{fig:modgestdiag} représente la composition du module de diagnostic intelligent et recommandation.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.7\textwidth]{./images/modulediag.drawio.png}  
    \label{fig:modgestdiag}   % label pour faire référence dans le texte
    \caption{Composition du module Diagnostic intelligent}
\end{figure}
\FloatBarrier

\subsection{Étude des classes}
La \autoref{fig:class} illustre le diagramme de classes do notre système.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.8\textwidth]{./images/DiagClassePFA2.drawio.png}  
    \label{fig:class}   % label pour faire référence dans le texte
...
La \autoref{fig:user} représente la classe utilisateur.


\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classeUtilisateur.png}  
    \label{fig:user}   % label pour faire référence dans le texte
    \caption{classe Utilisateur}
\end{figure}
\FloatBarrier


Le \autoref{tab:tabuser} représente les opérations de la classe Utilisateur.
...
La \autoref{fig:client} représente la classe client.


\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classeClient.png}  
    \label{fig:client}   % label pour faire référence dans le texte
...
La \autoref{fig:vendeur} représente la classe vendeur.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classeVendeur.png}  
    \label{fig:vendeur}   % label pour faire référence dans le texte
...
La \autoref{fig:admin} représente la classe administrateur.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classeAdmin.png}  
    \label{fig:admin}   % label pour faire référence dans le texte
...
La \autoref{fig:plnt} représente la classe plante.


\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classePlante.png}  
    \label{fig:plnt}   % label pour faire référence dans le texte
    \caption{classe Plante}
\end{figure}
\FloatBarrier

Le \autoref{tab:plante} présente les opérations de la classe Plante.
...
La \autoref{fig:imgpplnt} représente la classe plante.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classeImagePlante.png}  
    \label{fig:imgpplnt}   % label pour faire référence dans le texte
    \caption{classe ImagePlante}
\end{figure}
\FloatBarrier


Le \autoref{tab:imageplante} présente les opérations de la classe ImagePlante.

\begin{table}[h]
\centering
\caption{Opérations de la classe ImagePlante}
\label{tab:imageplante}
\begin{tabular}{|m{5cm}|m{8cm}|}
\hline
\textbf{Opération} & \textbf{Description} \\
\hline
...
La \autoref{fig:cmd} représente la classe commande.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.4\textwidth]{./images/cmd.drawio.png}  
    \label{fig:cmd}   % label pour faire référence dans le texte
    \caption{classe Commande}
\end{figure}
\FloatBarrier


Le \autoref{tab:commande} présente les opérations de la classe Commande.
...
La \autoref{fig:lgncmd} représente la classe ligne de commande.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classeLigneDeCommande.png}  
    \label{fig:lgncmd}   % label pour faire référence dans le texte
...
La \autoref{fig:diag} représente la classe diagnostic.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./images/diag.drawio.png}  
    \label{fig:diag}   % label pour faire référence dans le texte
    \caption{figure: classe Diagnostic}
\end{figure}
\FloatBarrier

Le \autoref{tab:diagnostic} présente les opérations de la classe Diagnostic.
...
La \autoref{fig:rec} représente la classe recommandation AI.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.3\textwidth]{./image/classeRecommandation.png}  
    \label{fig:rec}   % label pour faire référence dans le texte
    \caption{classe Recommandation AI}
\end{figure}
\FloatBarrier

Le \autoref{tab:recommandation} présente les opérations de la classe Recommandation AI.

\begin{table}[h]
\centering
\label{tab:recommandation}  
...
La \autoref{fig:seq} représente le diagramme de sequence du cas d'utilisation : Effectuer diagnostic.

\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=1\textwidth]{./image/diagSequenceAI.png}  
    \label{fig:seq}   % label pour faire référence dans le texte
