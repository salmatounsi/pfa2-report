...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    ...
    \includegraphics[width=0.5\textwidth]{./image/ImageModule.png}  
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/gestionUtilisateur.png}  
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/DiagnosticIntelligent.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/diagClasse.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeUtilisateur.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeClient.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeVendeur.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeAdmin.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classePlante.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeImagePlante.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeCommande.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeLigneDeCommande.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeDiagnostique.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/classeRecommandation.png}  
    \label{}   % label pour faire référence dans le texte
...
\begin{figure}[h]       % "h" = ici, essaye de garder l'image à cet endroit
    \centering          % centre l'image
    \includegraphics[width=0.5\textwidth]{./image/diagSequenceAI.png}  
    \label{}   % label pour faire référence dans le texte
